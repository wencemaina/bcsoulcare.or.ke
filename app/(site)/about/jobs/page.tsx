						...
						<div className="bg-white rounded-lg shadow-lg p-8">
							...
							<div className="prose max-w-none">
								<p className="text-muted-foreground mb-6">
									CCMWA is always looking for dedicated
									individuals who share our vision of
									providing Christ-centered counseling and
									soul-care to our community. We offer both
									full-time positions and volunteer
									opportunities.
								</p>
								...
								<div className="space-y-6 my-8">
									<Card>
										...
										<CardContent>
											<p className="text-muted-foreground mb-4">
												...
												professional counselor to join
												our clinical team. The ideal
												candidate will have experience
												in faith-based counseling and a
												heart for serving others through
									...
									<Card>
										...
										<CardContent>
											<p className="text-muted-foreground mb-4">
												We are looking for an organized
												and detail-oriented
												administrative assistant to
												support our office operations.
												This role is essential to
												keeping our ministry running
												smoothly.
											</p>
											<h4 className="font-semibold text-foreground mb-2">
												Responsibilities:
								...
								<div className="grid md:grid-cols-2 gap-6 my-8">
									...
									<Card>
										...
										<CardContent>
											<p className="text-muted-foreground mb-4">
												Join our prayer team to support
												our counseling ministry through
												intercession.
											</p>
											<p className="text-sm text-muted-foreground">
												<strong>
									...
									<Card>
										...
										<CardContent>
											<p className="text-muted-foreground mb-4">
												Greet visitors and provide
												assistance during our community
								...
								<div className="bg-primary/5 rounded-lg p-6 my-8">
									...
									<p className="text-muted-foreground mb-4">
										...
										explaining your interest in our ministry
										to:
									</p>
									...
									<p className="text-muted-foreground mt-4">
										For volunteer opportunities, please fill
										out our volunteer interest form and
										we'll contact you about upcoming
