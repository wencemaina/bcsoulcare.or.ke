				...
				<section className="bg-gradient-to-b from-primary/5 to-background py-16">
					<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
						...
						<p className="text-xl text-muted-foreground text-pretty">
							Our dedicated team serves with excellence through
							your partnership.
						</p>
					</div>
				</section>
						...
						<div className="bg-white rounded-lg shadow-lg p-8">
							...
							<div className="prose max-w-none">
								<p className="text-muted-foreground mb-6">
									Our staff members are dedicated to serving
									our community with excellence through
									Christ-centered counseling and soul-care.
									Your support enables them to continue this
									vital ministry.
								</p>
									...
									<Card>
										...
										<CardContent>
											<p className="text-muted-foreground mb-4">
												...
												professional needs of our team.
											</p>
											<Button
												variant="outline"
												className="w-full"
								...
								<div className="bg-primary/5 rounded-lg p-6 my-8">
									...
									<p className="text-muted-foreground mb-4">
										...
										for providing Christ-centered care to
										those in need. Each team member is
